...
1. Make sure you have installed Python on your VIRTUAL machine.
2. Clone or download this repository to your VIRTUAL machine.
3. Run the `game.py` file.
4. Cross your fingers and hope you don't delete a critical system file!
---
## Rules
...
**DO NOT** run this script on an actual Windows system, as it can lead to severe damage and render your system unusable. This project should be treated as a joke.

## P.S. Personal Contribution
- If you get an error, you know how to fix ;) 
- If you don't know, just leave this repo!
